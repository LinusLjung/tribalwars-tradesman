...
/***/ function(module, exports, __webpack_require__) {
	...
	var Popup = function (_State) {
		(0, _inherits3.default)(Popup, _State);
	
		function Popup() {
			(0, _classCallCheck3.default)(this, Popup);
	
			var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Popup).call(this));
	
			var message = new _message2.default('getVillages');
	
			message.responseCallback = function (response) {
				_this.setState({
					worlds: (0, _assign2.default)(_this.state.worlds, response)
				});
			};
	
			message.send();
	
			_this.containerRender = document.body.querySelector('[data-hook=render]');
		...
		(0, _createClass3.default)(Popup, [{
			...
			value: function render() {
				this.containerRender.innerHTML = (0, _popup2.default)({
			...
			value: function afterRender() {
				...
				this.containerRender.querySelector('#test').addEventListener('click', function (e) {
					console.log(e.target);
					_this2.fetchVillages();
				}, false);
			}
		}, {
			key: 'fetchVillages',
			value: function fetchVillages() {}
		}]);
		return Popup;
	}(_state2.default);
	...
	var Message = function () {
		(0, _createClass3.default)(Message, null, [{
			...
			value: function addListener(listener) {
				_chrome2.default.runtime.onMessage.addListener(listener);
			}
		}]);
		...
		(0, _createClass3.default)(Message, [{
			...
			value: function send() {
				...
				_chrome2.default.runtime.sendMessage(this.extensionId || null, data, this.options, this.responseCallback || this.noop);
			}
		}]);
		return Message;
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(10)(IteratorPrototype, __webpack_require__(63)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (test, undefined, worlds) {
	buf.push("<h1>Test jade " + (jade.escape((jade_interp = test) == null ? '' : jade_interp)) + "</h1><button id=\"test\">test</button><div>");
	// iterate worlds
	;(function(){
	  var $$obj = worlds;
	...
	buf.push("<ul>");
	// iterate world.villages
	;(function(){
	  var $$obj = world.villages;
	  if ('number' == typeof $$obj.length) {
	
	    for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
	      var village = $$obj[$index];
	
	buf.push("<li>" + (jade.escape(null == (jade_interp = village.name) ? "" : jade_interp)) + "</li>");
	    }
	
	  } else {
	    var $$l = 0;
	    for (var $index in $$obj) {
	      $$l++;      var village = $$obj[$index];
	...
	buf.push("</div>");}.call(this,"test" in locals_for_with?locals_for_with.test:typeof test!=="undefined"?test:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined,"worlds" in locals_for_with?locals_for_with.worlds:typeof worlds!=="undefined"?worlds:undefined));;return buf.join("");
	}
